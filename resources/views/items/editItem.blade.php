                                    ...
                                    <form action="{{ route('item.update', $item->id) }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3 label-align"
                                                for="Item-date">Item Date <span class="required">*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 ">
                                                <input type="date" id="Item-date" name="item_date" value="{{old('item_date',$item->item_date)}}" required="required"
                                                    class="form-control ">
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 ">
                                                <input type="text" id="title" name="title" value="{{old('title',$item->title)}}" required="required"
                                                    class="form-control ">
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 ">
                                                <input id="content" name="licence" value="{{old('licence',$item->licence)}}" required="required" class="form-control">
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            <label for="dimension"
                                            ...
                                            <div class="col-md-6 col-sm-6 ">
                                                <input id="dimension" class="form-control" type="text"
                                                    name="dimension" value="{{old('dimension',$item->dimension)}}" required="required">
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            <label for="format"
                                                class="col-form-label col-md-3 col-sm-3 label-align">Format <span
                                                    class="required">*</span></label>
                                            <div class="col-md-6 col-sm-6 ">
                                                <input id="format" class="form-control" type="text"
                                                    name="format" value="{{old('format',$item->format)}}" required="required">
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            ...
                                            <div class="checkbox">
                                                <label>
                                                    <input type="checkbox" name="active" value="1" class="flat" {{ old('active', $item->active) ? 'checked' : '' }}>
                                                    Active
                                                </label>
                                            </div>
                                        ...
                                        <div class="item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3 label-align"
                                                for="image">Image <span class="">*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 ">
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 ">
                                                <input id="dimension" class="form-control" type="price" name="price" value="{{old('price',$item->price)}}" required="required">
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3 label-align" for="tag_id">Tag <span class="required">*</span></label>
                                            <div class="col-md-6 col-sm-6">
                                                <select class="form-control" name="tag_id" id="tag_id">
                                                    <option value="">Select Tag</option>
                                                    @foreach ($tags as $tag)
                                                        <option value="{{ $tag->id }}" {{ old('tag_id', $item->tag_id) == $tag->id ? 'selected' : '' }}>
                                                            {{ $tag->title }}
                                                        </option>
                                                    @endforeach
                                                </select>
